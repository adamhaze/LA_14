...
ggplot(data = reg_tst) +    
  ...
  labs(title = "Distribution of Difference in the variant values from Random Groupings from the year 1987 in the Pacific and Lake States Regions")


my_result <- sum(var_result> 0.86787)

percentile_data <- my_result/1000
